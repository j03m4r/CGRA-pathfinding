module hybrid_wrapper
	...
	logic [31:0] cgra_data_addr[3:0];
	logic [127:0] cgra_data_rdata;
	logic [31:0] cgra_data_wdata[3:0];
	logic [3:0] cgra_we_i;
	logic [31:0] cgra_io[11:0];
	logic [4:0] select_port;
	logic [31:0] end_port;
	logic use_counter;
	logic end_cgra;
...
module mm_ram
	...
	input logic [31:0] cgra_data_addr[3:0],
	input logic [31:0] cgra_data_wdata[3:0],
	output logic [127:0] cgra_data_rdata,
	input logic [3:0] cgra_we_i,
	...
	localparam int BANK_ADDR_WIDTH = RAM_ADDR_WIDTH - 2;
	...
	always_comb begin
		...
		cgra_bank_enable = {4{cgra_enable}};
	end
	always_comb begin
		ram_bank_enable = '0;
